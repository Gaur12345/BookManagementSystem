...
<p>User Name</p>
<input type="text" name="name" id="uname" placeholder="Enter the username " autocomplete="off" required />
<p>Gender</p>
<select name="gender" >
...
<p id="p1" >Email</p>
<input type="email" name="email" id="email" placeholder="Enter Useremail" required  autocomplete="on" required />

<p id="p2" >Mobile Number</p>
<input type="number" name="mobile" id="mobile" placeholder="Enter the Mobile Number "  autocomplete="off" required />
<p id="p3">Password</p>
